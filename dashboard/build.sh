...
echo "Building dashboard version ${PROJECT_VERSION} with common version ${COMMON_VERSION}"
...
cd dashboard # Go back to the original directory (optional, but good practice)